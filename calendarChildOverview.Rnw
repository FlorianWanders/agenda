...
#                               align= c("",#no rownames, so first entry will be ignored; 
#                                        #include dimexpr\\textwidth-2\\pgflinewidth\\relax in 1st actual entry
#                                        #no brackets needed at first ignored entry and last included entry, will be automatically set
#                                        "\\dimexpr\\textwidth-2\\pgflinewidth\\relax}{>{\\raggedright\\arraybackslash\\hsize=0.23\\hsize}X|",
#                                        ">{\\raggedright\\arraybackslash\\hsize=0.23\\hsize}X|",
#                                        ">{\\raggedright\\arraybackslash\\hsize=0.23\\hsize}X|",
#                                        ">{\\raggedright\\arraybackslash\\hsize=0.23\\hsize}X|",
#                                        ">{\\raggedright\\arraybackslash\\hsize=0.23\\hsize}X|",
#                                        ">{\\raggedright\\arraybackslash\\hsize=0.23\\hsize}X|")),
